...
cd .\dist\myrmidon\cadmus-geo-location
call npm publish --access=public
cd ..\..\..
pause
...
cd .\dist\myrmidon\cadmus-refs-biblissima-lookup
call npm publish --access=public
cd ..\..\..
pause
...
cd .\dist\myrmidon\cadmus-refs-iconclass-lookup
call npm publish --access=public
cd ..\..\..
pause
...
cd .\dist\myrmidon\cadmus-refs-mol-lookup
call npm publish --access=public
cd ..\..\..
pause
